...
[![Travis Status for genghongjie/go-oauth2-server](https://travis-ci.org/genghongjie/go-oauth2-server.svg?branch=master&label=linux+build)](https://travis-ci.org/genghongjie/go-oauth2-server)
[![godoc for genghongjie/go-oauth2-server](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/genghongjie/go-oauth2-server)
[![codecov for genghongjie/go-oauth2-server](https://codecov.io/gh/genghongjie/go-oauth2-server/branch/master/graph/badge.svg)](https://codecov.io/gh/genghongjie/go-oauth2-server)

[![Sourcegraph for genghongjie/go-oauth2-server](https://sourcegraph.com/github.com/genghongjie/go-oauth2-server/-/badge.svg)](https://sourcegraph.com/github.com/genghongjie/go-oauth2-server?badge)
...
This server is easily extended or modified through the use of plugins. Four services, [health](https://github.com/genghongjie/go-oauth2-server/tree/master/health), [oauth](https://github.com/genghongjie/go-oauth2-server/tree/master/oauth), [session](https://github.com/genghongjie/go-oauth2-server/tree/master/session) and [web](https://github.com/genghongjie/go-oauth2-server/tree/master/web) are available for modification.
...
docker run -e ETCD_ENDPOINTS=localhost:2379 -p 8081:8081 --name go-oauth2-server go-oauth2-server:latest
```
